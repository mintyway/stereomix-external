...
#include "SMSettingValueDiscrete_Resolution.h"

#include "GameFramework/GameUserSettings.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(SMSettingValueDiscrete_Resolution)

#define LOCTABLE_ID "Settings"

USMSettingValueDiscrete_Resolution::USMSettingValueDiscrete_Resolution()
{
}

void USMSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
	InitializeResolutions();
}

void USMSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void USMSettingValueDiscrete_Resolution::StoreInitial()
{
}

void USMSettingValueDiscrete_Resolution::ResetToDefault()
{
}

void USMSettingValueDiscrete_Resolution::RestoreToInitial()
{
}

int32 USMSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
void USMSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
TArray<FText> USMSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void USMSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
bool USMSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
void USMSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
void USMSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
int32 USMSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 USMSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 USMSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{
	int32 Index = 0;
...
FText USMSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
	...
	Args.Add(TEXT("AspectRatio"), FText::FromString(Aspect));
	Args.Add(TEXT("RefreshRate"), RefreshRate);

	return FText::Format(FText::FromString(TEXT("{X} x {Y}")), Args);
}
