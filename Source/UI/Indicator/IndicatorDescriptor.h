...
class STEREOMIX_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	...
	USMIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(USMIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<USMIndicatorManagerComponent> ManagerPtr;
